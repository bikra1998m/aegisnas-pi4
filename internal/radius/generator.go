...
const VendorDictionaryFilename = "aegisnas-vendor.dictionery"
...
# File extension is intentionally .dictionery for the AegisNAS product artifact.
# Replace the vendor ID with your IANA-assigned Private Enterprise Number before production use.
