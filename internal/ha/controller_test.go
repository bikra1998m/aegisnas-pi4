...
func TestStandbyWitnessURLsBlockPromotionWhenRequiredURLIsMissing(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessQuorum = 2
	cfg.HighAvailability.WitnessRequiredURLs = []string{"https://witness-a.example.test/ha"}
	now := time.Date(2026, 5, 7, 13, 16, 0, 0, time.UTC)
	...
	fencing := ctrl.evaluateFencing(now, false, true, map[string]any{})
	assert.Equal(t, "url_unmet", fencing.WitnessStatus)
	assert.False(t, fencing.AllowPromotion)
...
func TestStandbyWitnessGroupsBlockPromotionWhenRequiredGroupIsMissing(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessRequiredGroups = []string{"dc-a"}
	now := time.Date(2026, 5, 7, 13, 16, 30, 0, time.UTC)
...
func TestStandbyWitnessGroupsAllowPromotionWhenRequiredGroupIsPresent(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessRequiredGroups = []string{"dc-a"}
	now := time.Date(2026, 5, 7, 13, 16, 45, 0, time.UTC)
...
func TestStandbyWitnessURLsAllowPromotionWhenRequiredURLIsPresent(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessQuorum = 2
	cfg.HighAvailability.WitnessRequiredURLs = []string{"https://witness-a.example.test/ha"}
	now := time.Date(2026, 5, 7, 13, 17, 0, 0, time.UTC)
...
func TestStandbyWitnessTierURLsBlockPromotionWhenTierURLIsMissing(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessRequiredURLsByTier = map[string][]string{
		"critical": {"https://witness-a.example.test/ha"},
	}
	now := time.Date(2026, 5, 7, 13, 26, 0, 0, time.UTC)
	...
	fencing := ctrl.evaluateFencing(now, false, true, map[string]any{})
	assert.Equal(t, "tier_url_unmet", fencing.WitnessStatus)
	assert.False(t, fencing.AllowPromotion)
...
func TestStandbyWitnessTierURLsAllowPromotionWhenTierURLIsPresent(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	now := time.Date(2026, 5, 7, 13, 28, 0, 0, time.UTC)
...
func TestStandbyWitnessTierPolicyAnyAllowsPromotionWhenOneTierFamilyPasses(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessPolicyModeByTier = map[string]string{
		"critical": "any",
	}
	now := time.Date(2026, 5, 7, 13, 39, 0, 0, time.UTC)
...
func TestStandbyWitnessTierPolicyGroupOnlyBlocksPromotionWhenOnlySourcesPass(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	now := time.Date(2026, 5, 7, 13, 41, 0, 0, time.UTC)
	...
	fencing := ctrl.evaluateFencing(now, false, true, map[string]any{})
	assert.Equal(t, "tier_policy_unmet", fencing.WitnessStatus)
	assert.False(t, fencing.AllowPromotion)
...
func TestStandbyWitnessTierPolicyURLOnlyBlocksPromotionWhenRequiredURLIsMissing(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	now := time.Date(2026, 5, 7, 13, 42, 0, 0, time.UTC)
...
func TestStandbyWitnessTierPolicyURLOnlyAllowsPromotionWhenRequiredURLIsPresent(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	now := time.Date(2026, 5, 7, 13, 44, 0, 0, time.UTC)
...
func TestStandbyWitnessPolicyURLOnlyAllowsPromotionWhenURLRulePasses(t *testing.T) {
	cfg := haTestConfig(t, "standby")
	cfg.HighAvailability.SplitBrainProtectionEnabled = true
	cfg.HighAvailability.WitnessAPIURL = ""
	cfg.HighAvailability.WitnessURLs = []string{
	...
	cfg.HighAvailability.WitnessQuorum = 2
	cfg.HighAvailability.WitnessPolicyMode = "url_only"
	cfg.HighAvailability.WitnessMinDistinctGroups = 2
	cfg.HighAvailability.WitnessGroups = map[string]string{
		"https://witness-a.example.test/ha": "dc-a",
		"https://witness-b.example.test/ha": "dc-a",
	...
	cfg.HighAvailability.WitnessRequiredURLs = []string{"https://witness-a.example.test/ha"}
	now := time.Date(2026, 5, 7, 13, 47, 0, 0, time.UTC)
