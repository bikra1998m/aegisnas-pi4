...
func supportBundleAPICaptures() []supportBundleAPICapture {
	return []supportBundleAPICapture{
		...
		{archivePath: "api/accounting-charging.json", requestPath: "/api/v1/system/accounting-charging", label: "Charging records, rating, and export integrity", handler: HandleGetAccountingCharging},
		...
		{archivePath: "api/tacacs.json", requestPath: "/api/v1/system/tacacs", label: "TACACS+ command authorization and accounting evidence", handler: HandleGetTACACS},
		{archivePath: "api/tenant-isolation.json", requestPath: "/api/v1/system/tenant-isolation", label: "Tenant isolation and delegated policy ownership", handler: HandleGetTenantIsolation},
