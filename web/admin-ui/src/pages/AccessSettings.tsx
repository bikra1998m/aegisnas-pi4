      ...
      <section className="rounded-lg bg-white p-6 shadow">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <ToggleField
            ...
            onChange={(value) => updateField(['telemetry', 'session_exports', 'enabled'], value)}
          />
          <TextField
            label="Session Export Directory"
            value={settings.telemetry?.session_exports?.directory || '/var/lib/aegisnas/session-exports'}
            onChange={(value) => updateField(['telemetry', 'session_exports', 'directory'], value)}
          />
          <SelectField
            label="Session Export Format"
            value={settings.telemetry?.session_exports?.format || 'both'}
            onChange={(value) => updateField(['telemetry', 'session_exports', 'format'], value)}
            options={[
              { value: 'json', label: 'JSON' },
              { value: 'csv', label: 'CSV' },
              { value: 'both', label: 'JSON + CSV' },
          ...
          <TextField
            ...
            onChange={(value) => updateField(['telemetry', 'session_exports', 'interval_minutes'], Number(value))}
          />
          <TextField
          ...
          <ToggleField
            ...
            onChange={(value) => updateField(['telemetry', 'integration_exports', 'enabled'], value)}
          />
          <TextField
            label="Integration Export Directory"
            value={settings.telemetry?.integration_exports?.directory || '/var/lib/aegisnas/integration-exports'}
            onChange={(value) => updateField(['telemetry', 'integration_exports', 'directory'], value)}
          />
          <SelectField
            label="Integration Export Format"
            value={settings.telemetry?.integration_exports?.format || 'json'}
            onChange={(value) => updateField(['telemetry', 'integration_exports', 'format'], value)}
            options={[
              { value: 'json', label: 'JSON' },
              { value: 'csv', label: 'CSV' },
              { value: 'both', label: 'JSON + CSV' },
          ...
          <TextField
            ...
            type="number"
            value={settings.telemetry?.integration_exports?.interval_minutes || 60}
            onChange={(value) => updateField(['telemetry', 'integration_exports', 'interval_minutes'], Number(value))}
          />
          <TextField
          ...
          <ToggleField
            ...
            onChange={(value) => updateField(['telemetry', 'upstream_aaa_exports', 'enabled'], value)}
          />
          <TextField
            label="Upstream AAA Export Directory"
            value={settings.telemetry?.upstream_aaa_exports?.directory || '/var/lib/aegisnas/upstream-aaa-exports'}
            onChange={(value) => updateField(['telemetry', 'upstream_aaa_exports', 'directory'], value)}
          />
          <SelectField
            label="Upstream AAA Export Format"
            value={settings.telemetry?.upstream_aaa_exports?.format || 'json'}
            onChange={(value) => updateField(['telemetry', 'upstream_aaa_exports', 'format'], value)}
            options={[
              { value: 'json', label: 'JSON' },
              { value: 'csv', label: 'CSV' },
              { value: 'both', label: 'JSON + CSV' },
          ...
          <TextField
            ...
            type="number"
            value={settings.telemetry?.upstream_aaa_exports?.interval_minutes || 60}
            onChange={(value) => updateField(['telemetry', 'upstream_aaa_exports', 'interval_minutes'], Number(value))}
          />
          <TextField
