...
- `witness_min_distinct_sources_by_tier`: optional per-tier source diversity floors; promotion must include approvals from at least this many distinct witness sources in each listed confidence tier
