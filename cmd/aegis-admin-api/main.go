...
func registerAdminRoutes(r chi.Router, cfg *config.Config) {
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Post("/auth/token/start", adminapi.HandleAdminTokenStart)
		r.Post("/auth/webauthn/login/options", adminapi.HandleAdminWebAuthnLoginOptions)
		r.Post("/auth/webauthn/login/finish", adminapi.HandleAdminWebAuthnLoginFinish)
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/system/dac-client/history", adminapi.HandleListOutboundDACHistory)
			...
			r.Get("/system/supplicant-lifecycle", adminapi.HandleGetSupplicantLifecycle)
			r.Post("/system/supplicant-lifecycle/evaluate", adminapi.HandleEvaluateSupplicantLifecycle)
			r.Post("/system/supplicant-lifecycle/profile", adminapi.HandleRenderSupplicantProfile)
			...
			r.Get("/system/accounting-ingest-spool", adminapi.HandleGetAccountingIngestSpool)
			r.Post("/system/accounting-ingest-spool/replay", adminapi.HandleReplayAccountingIngestSpool)
			r.Get("/system/accounting-charging", adminapi.HandleGetAccountingCharging)
			r.Post("/system/accounting-charging/reconcile", adminapi.HandleReconcileAccountingCharging)
			r.Post("/system/accounting-charging/export", adminapi.HandleExportAccountingCharging)
			r.Get("/system/accounting-charging/export/download", adminapi.HandleDownloadAccountingChargingExport)
			...
			r.Get("/system/accounting-ip", adminapi.HandleGetAccountingIP)
			r.Get("/system/accounting-services", adminapi.HandleGetAccountingServices)
			...
			r.Post("/system/policy-sets/versions", adminapi.HandleCreatePolicySetVersion)
			r.Get("/system/policy-sets/versions/{id}", adminapi.HandleGetPolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/submit", adminapi.HandleSubmitPolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/approve", adminapi.HandleApprovePolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/reject", adminapi.HandleRejectPolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/activate", adminapi.HandleActivatePolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/rollback", adminapi.HandleRollbackPolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/simulate", adminapi.HandleSimulatePolicySetVersion)
			r.Post("/system/policy-sets/versions/{id}/analyze", adminapi.HandleAnalyzePolicySetVersion)
			r.Get("/system/policy-sets/versions/{fromID}/compare/{toID}", adminapi.HandleComparePolicySetVersions)
			r.Get("/system/tenant-isolation", adminapi.HandleGetTenantIsolation)
			r.Post("/system/tenant-isolation/evaluate", adminapi.HandleEvaluateTenantIsolation)
			r.Post("/system/tenant-isolation/tenants", adminapi.HandleUpsertTenantProfile)
			r.Put("/system/tenant-isolation/tenants/{tenant}", adminapi.HandleUpsertTenantProfile)
			r.Post("/system/tenant-isolation/resources", adminapi.HandleUpsertTenantResourceBinding)
			r.Get("/system/subscriber-service-chains", adminapi.HandleGetSubscriberServiceChains)
			r.Post("/system/subscriber-service-chains/preview", adminapi.HandlePreviewSubscriberServiceChain)
			r.Post("/system/subscriber-service-chains/activate", adminapi.HandleActivateSubscriberServiceChain)
			r.Post("/system/subscriber-service-chains/{chainID}/rollback", adminapi.HandleRollbackSubscriberServiceChain)
			r.Get("/system/tacacs", adminapi.HandleGetTACACS)
			r.Post("/system/tacacs/evaluate", adminapi.HandleEvaluateTACACSCommand)
			r.Post("/system/tacacs/command-sets", adminapi.HandleCreateTACACSCommandSet)
			r.Put("/system/tacacs/command-sets/{name}", adminapi.HandleUpdateTACACSCommandSet)
			...
			r.Post("/system/mfa/recovery-codes", adminapi.HandleRotateMFARecoveryCodes)
			r.Get("/system/webauthn", adminapi.HandleGetAdminWebAuthn)
			r.Post("/system/webauthn/register/options", adminapi.HandleBeginAdminWebAuthnRegistration)
			r.Post("/system/webauthn/register/finish", adminapi.HandleFinishAdminWebAuthnRegistration)
			r.Delete("/system/webauthn/credentials/{id}", adminapi.HandleRevokeAdminWebAuthnCredential)
			r.Get("/system/mab", adminapi.HandleGetMAB)
			r.Get("/system/mab/endpoints", adminapi.HandleListMABEndpoints)
			r.Post("/system/mab/endpoints", adminapi.HandleUpsertMABEndpoint)
			r.Put("/system/mab/endpoints/{mac}", adminapi.HandleUpsertMABEndpoint)
			r.Delete("/system/mab/endpoints/{mac}", adminapi.HandleDeleteMABEndpoint)
			r.Post("/system/mab/evaluate", adminapi.HandleEvaluateMAB)
